...
module.exports = class UserRepository {
  ...
  constructor(){
    Object.defineProperty(UserRepository, 'instance', {writable: true, configurable: true, enumerable: false})
  ...
  #loadFile() {
    const readData = JSON.parse(fs.readFileSync(this.#dbPath), 'utf-8')
